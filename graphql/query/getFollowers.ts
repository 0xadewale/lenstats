...
/**
 * Load a user's followers by their profile id.
 */
async function getFollowers(profileId: string): Promise<FollowerProfile[]> {
  ...
  return response.data.followers.items as FollowerProfile[];
}
